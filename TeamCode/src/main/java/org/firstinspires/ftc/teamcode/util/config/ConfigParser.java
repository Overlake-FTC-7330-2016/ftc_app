...
public class ConfigParser {
    ...
    public ConfigParser(String filename) {
        ...
        try {
            ...
            throw new IllegalStateException("ERROR: CONFIG FILE " + filename + "DOES NOT EXIST");
        }
    }
    ...
    public String getValue(String key, String type) {
        if (configData.containsKey(key)) {
            if (configData.get(key)[0].equals(type)) {
                ...
                throw new IllegalStateException("KEY " + key + " DOES NOT MATCH TYPE " + type + ".");
            }
        } else {
    ...
    public String toString() {
        ...
        for (String key : configData.keySet()) {
            String[] data = configData.get(key);
